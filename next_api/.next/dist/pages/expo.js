...
var MyPage = function (_React$Component) {
  ...
  (0, _createClass3.default)(MyPage, [{
    ...
    value: function render() {
      return _react2.default.createElement('div', null, _react2.default.createElement('p', null, 'Expo has ', this.props.stars, ' \u2B50\uFE0F'), _react2.default.createElement(_link2.default, { prefetch: true, href: '/' }, _react2.default.createElement('a', null, 'I bet nativebase has more stars (?)')));
    }
  }], [{
    key: 'getInitialProps',
    value: function () {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch('https://api.github.com/repos/expo/expo');
